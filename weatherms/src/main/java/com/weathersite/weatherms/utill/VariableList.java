package com.weathersite.weatherms.utill;

public class VariableList {
    public static final String RESPONSE_SUCCESS = "00";
    public static final String RESPONSE_NO_DATA_FOUND= "01";
    public static final String RESPONSE_NO_DATA_AUTHORISED= "02";
    public static final String RESPONSE_NO_DATA_EXPIRED= "03";
